...
/**----------------------------------------------
 * Implementação das funções da TAD:
 * ----------------------------------------------*/
// Função para criar uma lista estática
Lista *criar_lista()
{
...
Lista *intercala_ordenado(Lista *l1, Lista *l2)
{
    ...
    // Inserir elementos de l1 na lista l3 de forma ordenada
    for (int i = 0; i < l1->tam; i++)
    {
        inserir_ordenado(l3, l1->item[i]);
    }

    // Inserir elementos de l2 na lista l3 de forma ordenada
